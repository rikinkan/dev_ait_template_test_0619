...
## sample ##
    ...
    manifest_genenerator.set_ait_name('dev_ait_template_test_0619')
    manifest_genenerator.set_ait_description('AIT template (docker image regist to remote)')
    manifest_genenerator.set_ait_source_repository('https://github.com/rikinkan/dev_ait_template_test_0619')
    manifest_genenerator.set_ait_version('2.0')
